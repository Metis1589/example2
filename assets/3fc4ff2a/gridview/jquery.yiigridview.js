...
;(function($) {
	...
	$.fn.yiiGridView = function(options) {
		return this.each(function(){
			...
			var searchInputSelector='.search-form :submit';
			$('body').undelegate(searchInputSelector, 'click').delegate(searchInputSelector, 'click', function(){
				var data = "";
				$(".search-form form input[type!=submit]").each(function(i){
				...
				$(".search-form form select").each(function(i){
					if($(this).val()!=$(this).find("option:first").val()){
				    	data += $(this).attr("name") + "/" + $(this).val() + "/" ;
					}
				});
				location = location.protocol+"//"+location.host+$("div.keys").attr("title")+"/"+data;
				return false;
			});		
